# Prime Number Sieve
# https://www.nostarch.com/cracking codes/ (BSD Licensed)
# Cracking Codes Book p.324
...
# Most of the time we can quickly dertermine if a number is not prime
# by dividing by the first dozen prime numbers. This is quicker
...
def isPrime(num):
    ...
    # See if any orf the low prime numbers can divide num:
