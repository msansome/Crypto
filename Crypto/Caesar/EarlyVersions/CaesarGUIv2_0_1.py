...
class Application(Frame):
    ...
    def __init__(self,master):
        ...
        #bg = "Light Blue", bd = 3, relief = tk.RIDGE
        ...
        #self.vsbar = Scrollbar(self, orient="vertical", command=Can1.yview)
        #self.vsbar.grid(row=0, column=1, sticky='ns')
        self.grid(sticky = NSEW)

        self.input_frame = LabelFrame(self, text = "Ciphertext", bg = "Green")
        ...
        self.canvas = Canvas(self.key_selection_frame, bg="Yellow")
