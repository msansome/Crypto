...
class OverallForm(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        dec_instructions = tk.LabelFrame(parent, text="CIPHERTEXT: Please type, or paste, the text to be decrypted into this box")
        dec_instructions.grid(row=1, column=0, sticky=tk.W + tk.E)
        ...
        self.inputs['Date'].grid(row=1, column=0)

        # Draw the LabelFrame
        #dec_instructions.grid(row=0, column=0, sticky=(tk.W + tk.E))
