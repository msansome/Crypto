...
class MyFirstGUI:
    ...
    def __init__(self, master):
        ...
        self.key_label = Label(master, width=15, text="Enter key (1-26)")
        ...
        self.text_entry_box = Text(master, wrap=WORD, yscrollcommand=self.scrollbar1.set, height=4)
        self.text_output_box = Text(master,wrap=WORD, yscrollcommand=self.scrollbar2.set, height=4)
        ...
        self.key_entry_box.grid(row=4, column=1, sticky=E)
        self.decrypt_button.grid(row=4, column=2, sticky=E)
        ...
        self.text_entry_box.grid(row=3, column=0, columnspan=3, sticky=W)
        self.text_entry_box.config(yscrollcommand=self.scrollbar1.set)
        self.text_output_box.grid(row=6, column=0, columnspan=3, sticky=W)
